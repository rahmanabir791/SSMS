...
class Course extends Model
{
    ...
    public static function saveCourseData ($request, $id=null)
    {
        self::$course = Course::updateOrCreate(['id' => $id],[
            ...
            'image'                 => Helper::uploadImage($request->file('image'), 'admin/assets/images/course-images/', isset($id) ? Course::find($id)->image : null),
        ...
        if ($request->hasFile('sub_images'))
        {
            foreach ($request->file('sub_images') as $image)
            {
                CourseSubImage::create([
                    ...
                    'sub_image' => Helper::uploadImage($image, 'admin/assets/images/course-sub-images/'),
                ]);
            }
        }
    }
